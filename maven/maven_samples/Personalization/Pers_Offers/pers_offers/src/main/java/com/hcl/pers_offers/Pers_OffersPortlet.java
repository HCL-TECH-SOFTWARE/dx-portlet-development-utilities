 ...
 */
public class Pers_OffersPortlet extends GenericPortlet {

	public static final String JSP_FOLDER    = "/_Pers_Offers/jsp/";    // JSP folder name

	public static final String VIEW_JSP      = "Pers_OffersPortletView";         // JSP file name to be rendered on the view mode
